...
def main():
    ...
    # NOTE: 6.Training
    reclogger.info('This one is GRU type with {}.'.format(dataset_name))
    ...
    test_results, test_score = trainer.gru_eval_epoch(test_data, show_progress=True)
...
def create_recbole_config(model,dataset,filepath=None):
    # TODO:也可以从外部导入配置文件
    parameter_dict = {
        'data_path': "/data03/wangyidan-slurm/RecBole/dataset/", # ？
        'USER_ID_FIELD': 'user_id',
        'ITEM_ID_FIELD': 'item_id',
        'TIME_FIELD': 'timestamp',
        'user_inter_num_interval': "[3,inf)",  # 应该是用来筛选大小的
